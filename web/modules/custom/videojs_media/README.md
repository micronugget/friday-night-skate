...
2. **VideoJS Libraries**: This module includes its own copy of the VideoJS libraries in the `node_modules/` directory. The module is **fully self-contained** and does not depend on `videojs_mediablock`.
